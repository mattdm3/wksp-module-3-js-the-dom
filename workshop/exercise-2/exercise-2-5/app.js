...
function racingFrog(racer) {
    ...
    let randomDistance = Math.random() * 100 / trackWidth * 100;
...
const ranking = setInterval(function () {
    if (rank.length === racers.length) {
        console.log(rank);
        clearInterval(ranking);
    }
}, 500);